    ...
    return through.obj((file, enc, cb) => {
        ...
        if(file.isBuffer()){
            ...
            if(url && url !== ''){
                ...
                if ( imgFolder ) {
                    // 替换 img
                    const regexp = new RegExp(`\\.\\.\\/\\.\\.\\/${ imgFolder }\\/|\\.\\.\\/${ imgFolder }\\/|\\.\\/${ imgFolder }\\/`, 'gim');
                    fileString = fileString.replace(regexp, url + `/${ imgFolder }/`);
                }
